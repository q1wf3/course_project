...
erDiagram
    ...
    MOVIES }o--o{ GENRES : classified
    COLLECTION_ITEMS ||--o| REVIEWS : has
    COLLECTION_ITEMS }o--o{ TAGS : marked
```
...
CREATE TABLE reviews (
    id UUID PRIMARY KEY,
    collection_item_id UUID NOT NULL UNIQUE REFERENCES collection_items(id) ON DELETE CASCADE,
    text TEXT NOT NULL,
