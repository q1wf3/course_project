...
| FR-13 | Пользователь должен отправлять жалобу на фильм, а администратор должен рассматривать ее | Should |
...
| Модерировать содержимое | FR-11, FR-13 | Жалоба и администрирование |
