...
- отправка пользователем жалоб на карточки фильмов;
- административная панель для просмотра пользователей, ролей, статистики, коллекций и обработки жалоб;
...
Раздел фиксирует базовые метрики Git. На момент финальной версии в репозитории зафиксировано 19 коммитов; эти данные используются в отчете для подтверждения хода разработки и соответствия требованиям по управлению проектом.
